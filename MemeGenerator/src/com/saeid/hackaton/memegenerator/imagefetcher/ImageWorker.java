...
package com.saeid.hackaton.memegenerator.imagefetcher;
...
import com.saeid.hackaton.memegenerator.BuildConfig;
...
public abstract class ImageWorker {
	...
	public void addImageCache(FragmentActivity activity,
		...
		mImageCache = ImageCache.getInstance(activity.getFragmentManager(),
				mImageCacheParams);
		new CacheAsyncTask().execute(MESSAGE_INIT_DISK_CACHE);
	}
